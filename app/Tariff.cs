...
namespace NotesMinimalAPI.app
{
    public partial class Tariff
    {
        ...
        internal void fill(tariff t, bool full = false) { UslugaRef = t.usluga_ref; TDate = t.t_date; Price = t.price; if (full) TariffId = t.tariff_id; }
        public Tariff(tariff u)
        {
            fill(u, true);
        }
    ...
    public partial struct tariff
    {
        ...
        public decimal price { get; set; }
        public tariff(Tariff value) { tariff_id = value.TariffId; usluga_ref = value.UslugaRef; t_date = value.TDate; price = value.Price; }
    }
